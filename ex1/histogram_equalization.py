...
def compute_histogram(image: np.ndarray) -> np.ndarray:
    """
    Create a histogram for the given image (256 values).
    """
...
def show_images(original_image: np.ndarray, equalized_image: np.ndarray) -> None:
    """
    Display the original and the equalized images next to each other.
    """
...
def histogram_equalization(input_path: str, output_path: str) -> None:
    """
    Combine the different functions into one.
    """
